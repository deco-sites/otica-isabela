...
import { ISABELA_DIAS_NAME_COOKIE, ISABELA_DIAS_WISHLIST_IDS, } from "$store/packs/constants.ts";
...
export const loader = async ({ categories = [], ...props }: Props, req: Request, ctx: AppContext) => {
    ...
    if (isFavoritos) {
        ...
        const wishlistProductsPage = await ctx.invoke("site/loaders/product/productListiningPage.ts", { id: wishlistIds, ordenacao: "none" });
