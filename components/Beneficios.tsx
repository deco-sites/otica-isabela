...
export default function ({ benefits, noMargin }: Props) {
	return (
		<div
			class={clx(
				"flex flex-col md:flex-row bg-grayscale-0 rounded-[48px] mx-auto w-5/6 md:w-[calc(100%-12px)] max-w-[1240px] md:h-16 py-3.5 md:px-4 items-center justify-center md:divide-x divide-y md:divide-y-0 divide-slot-primary-500 shadow-[0_2px_10px_rgba(0,0,0,0.15)]",
