...
export default function ({ title, benefits }: Props) {
  return (
    <div class="max-w-[1200px] mx-auto w-[95%] flex flex-col max-[1200px]:items-center min-[1200px]:flex-row gap-5 mb-5 min-[768px]:mb-[90px]">
        ...
        {benefits.map(({ icon, label, alt }) => (
          <div class="flex gap-8 items-center">
            <Image
              ...
              width={75}
              height={75}
              class="max-[768px]:w-14 max-[768px]:h-14"
            />
