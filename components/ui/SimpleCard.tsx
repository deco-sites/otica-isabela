...
export default function ({ text, desktop, mobile, backgroundColor, isMobile, removeTextBgOnMobile, isSmall, }: ReturnType<typeof loader>) {
    return (<div class={"w-[95%] flex flex-col min-[768px]:flex-row justify-center items-center mx-auto gap-y-10 mb-5 min-[768px]:mb-[90px] " +
      ...
      <div dangerouslySetInnerHTML={{ __html: text }} class={"min-[768px]:w-1/2 min-[768px]:p-5 min-[1000px]:p-20 min-[768px]:text-base max-w-3xl text-sm leading-[1.5] text-black h-full flex flex-col justify-center max-[768px]:items-center max-[768px]:text-center" +
