	...
	return (
		...
		>
			<div class="max-w-[1200px] w-[95%] flex justify-center items-center h-full relative mx-auto">
				<div class="relative w-full h-full max-w-[700px] flex justify-center items-center">
					{texts.map(({ text, leftImage, rightImage }, i) => (
						<div
							class={clx(
						...
						>
							...
							<div
								...
								class={clx(
									"text-grayscale-600 [&_a]:text-slot-primary-500 [&_a]:underline [&_a]:underline-offset-2",
								)}
							/>
